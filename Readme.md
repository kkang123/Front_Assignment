...
- 컬럼 확장
- 드래그 제약 조건
  - 첫 번째 컬럼에서 세 번째 컬럼 이동 막기
  - 짝수 아이템이 앞에 있으면 뒤에 짝수 아이템 이동 불가능
  - 이동 불가능한 컬럼에 아이템을 이동 시 빨간색으로 색상 변경 및 제자리로 이동
- 다중 선택 구현
  - 클릭하여 다중 선택 가능
- 첫 번째 컬럼에서 아이템 추가 버튼 추가
- 네 번째 컬럼에서 아이템 삭제 기능 추가

  <br>

<details>
<summary>사전 과제 내용</summary>
<div markdown="1">
